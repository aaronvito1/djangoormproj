"""
Django settings for djangoormproj project. Includes some improvements
...
SECRET_KEY = 'django-insecure--6b4!n7c9mhr4+e39s^qbzz&c_ys^@gnosxg&pv03209@msmae'
...
ROOT_URLCONF = 'djangoormproj.urls'
